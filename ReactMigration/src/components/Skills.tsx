...
function SkillCard({ title, items, icon, delay = 0 }: SkillCardProps) {
  return (
    <Reveal delay={delay}>
    ...
    <section id="skills" className="py-24 px-6 bg-gray-900/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <SkillCard title="Technical" items={skills.technical} icon="fa-code" delay={0} />
          <SkillCard title="Soft Skills" items={skills.soft} icon="fa-brain" delay={100} />
          <SkillCard title="Languages" items={skills.languages} icon="fa-terminal" delay={200} />
          <SkillCard title="IDEs & Engines" items={skills.ides} icon="fa-gamepad" delay={300} />
          <SkillCard title="Spoken" items={skills.spoken} icon="fa-language" delay={400} />
        </div>
      </div>
    </section>
  );
